...
namespace SimpleJSON
{
    ...
    public class JSONNode
    {
        ...
        public static JSONNode Parse(string aJSON)
        {
            ...
            if (QuoteMode)
            {
                throw new Exception("JSON Parse: Quotation marks seems to be messed up: " + aJSON);
            }
            return ctx;
        }
    ...
    public class JSONClass : JSONNode, IEnumerable
    {
        ...
        public string getKeyAt(int idx){
        	return m_Dict.ElementAt(idx).Key;
        }
        
        
        public void AppendParse (string txt) {
        	JSONClass extra = (JSONClass) JSONNode.Parse(txt);
        
        	for (int i = 0; i < extra.Count; i++){
        		this[extra.getKeyAt(i)] = extra[i];
        	}
        }
